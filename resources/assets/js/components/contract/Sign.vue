<template>
  <div
    ...
    :class="boxWidth"
  >
    <h3 class="mb-4 text-center">Acceptance of
      <span class="capitalize">{{ type }}</span>
    </h3>
    <p
      class="flex-1 text-left"
    >To accept the terms of the above {{ type }}, please click the button below.</p>
    ...
    >
      <div class="text-left">
        <div>
          <p>To secure C.P.A. Valet services based on the terms and conditions outlined in {{ type }} #{{ contract }} complete the following steps:</p>
          <ol>
            <li>Sign in the signature box below.</li>
            <li>Click the "
              <span class="uppercase">I accept</span>" button below.
            </li>
          </ol>

          <p>Please refer to the {{ type }} for our cancellation policy.</p>
        </div>

        <div
          class="bg-blue-lightest border-l-4 border-blue text-blue-dark px-4 py-1 mb-3"
          role="alert"
        >
          <div class="font-bold capitalize my-2 text-md">How to Write Your Signature:</div>
          <div class="flex">
            <div class="mr-3 mb-2">
              <svg
            ...
            <div>Left-click and hold down your mouse while dragging to draw your signature.</div>
          </div>
          <div class="flex">
            ...
            <div>Draw your signature with your finger.</div>
          </div>
        </div>
        <cpa-canvas
          canvas="signature"
          ...
          :height="canvasH"
        />
        <div class="text-sm mb-2">X Sign above this bold line</div>
        <div class="text-sm">{{ firstName }} {{ lastName }} on {{ today }}</div>
        <transition name="fade">
          <div
            class="bg-red-lightest border-l-4 border-red text-red-dark p-2 mt-3"
            role="alert"
            v-if="signatureIsEmpty && submitAttempt"
          >
    ...
    >
      <div class="text-left">
        <p>
          Thank you! We have received your signed {{ type }}. An email confirmation has been sent to
          <em>{{ this.email }}</em>
          with your signed {{ type }}.
        </p>
        <div class="text-center">
          ...
          >
            <div class="fill-current mr-3">
              <svg class="h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                <path
                  d="M640 352c0 70.692-57.308 128-128 128H144C64.471 480 0 415.529 0 336c0-62.773 40.171-116.155 96.204-135.867A163.68 163.68 0 0 1 96 192c0-88.366 71.634-160 160-160 59.288 0 111.042 32.248 138.684 80.159C409.935 101.954 428.271 96 448 96c53.019 0 96 42.981 96 96 0 12.184-2.275 23.836-6.415 34.56C596.017 238.414 640 290.07 640 352zm-246.627-64H328V176c0-8.837-7.164-16-16-16h-48c-8.836 0-16 7.163-16 16v112h-65.373c-14.254 0-21.393 17.234-11.314 27.314l105.373 105.373c6.248 6.248 16.379 6.248 22.627 0l105.373-105.373c10.08-10.08 2.941-27.314-11.313-27.314z"
                ></path>
              </svg>
            </div>
...
export default {
  ...
  computed: {
    ...
    modalSignedTitle() {
      return `Signed ${this.type.charAt(0).toUpperCase() +
        this.type.substr(1)} Received`;
    },
    depositUrl() {
